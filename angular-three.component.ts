...
@Component({
  ...
  styleUrls: ['./angular-three.component.css']
})
export class AngularThreeComponent implements OnInit, AfterViewInit {
  ...
  @Input() public texture: string = "/assets/cheerois.jpg";
  ...
  private startRenderingLoop() {
    ...
    let component: AngularThreeComponent = this;
    (function render() {
